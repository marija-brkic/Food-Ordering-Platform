...
<html>
    ...
    <body>
        ...
        if(isset($_POST['azuriraj_ime'])){
            ...
            $result = mysqli_query($conn, "update konobari set ime='$ime' where kor_ime='$kor_ime'");
            if($result){
                mysqli_close($conn);
        ...
        if(isset($_POST['azuriraj_prezime'])){
            ...
            $result = mysqli_query($conn, "update konobari set prezime='$prezime' where kor_ime='$kor_ime'");
            if($result){
                mysqli_close($conn);
                header('Location: konobar.php');
            }
        ...
        ?>
        <hr/>
        <form method="post" action="konobar_rezervacije.php" >
            <input type="submit" name="logout" value="Rezervacije">
        </form>
        <form method="post" action="konobar_dostave.php" >
            <input type="submit" name="logout" value="Dostave">
        </form>
        <form method="post" action="konobar_statistika.php" >
            <input type="submit" name="logout" value="Statistika">
        </form>
        </div>
        </div>
        <div class="row">
