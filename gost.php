...
<html>
    ...
    <body>
        ...
        <form method="post" action="gost_restorani.php" >
            <input type="submit" name="gost_restorani" value="Restorani">
        </form>
        <form method="post" action="gost_rezervacije.php" >
            <input type="submit" name="gost_rezervacije" value="Rezervacije">
        </form>
        <form method="post" action="gost_dostava.php" >
            <input type="submit" name="gost_dostava" value="Dostava">
        </form>
        </div>
        </div>
        <div class="row">
