...
<html>
    ...
    <body>
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            Id restorana: <input type="number" name="id_restorana" min="1" max="<?php echo $max?>" required><br/>
            <input type="submit" name="dodaj" value="Dodaj konobara">
        </form>
        <?php
            if(isset($_POST['dodaj'])){
                require 'novi_konobar.php';
